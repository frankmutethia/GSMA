...
import { AuditQueue } from "@/components/auditor/audit-queue"
    ...
    <DashboardLayout role="auditor">
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Final certification review and approval</p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Ready for final review</p>
            </CardContent>
          </Card>
